...
namespace std {
    ...
    %template(PairStringStringVector) std::vector<std::pair<std::string, std::string> >;
    %template(PairStringString) std::pair<std::string, std::string>;
    %template(PairStringStringVector2) std::vector<std::vector<std::pair<std::string, std::string> > >;
}
