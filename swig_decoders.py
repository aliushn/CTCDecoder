...
class PairStringStringVector(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, PairStringStringVector, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, PairStringStringVector, name)
    __repr__ = _swig_repr

    def iterator(self):
        return _swig_decoders.PairStringStringVector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _swig_decoders.PairStringStringVector___nonzero__(self)

    def __bool__(self):
        return _swig_decoders.PairStringStringVector___bool__(self)

    def __len__(self):
        return _swig_decoders.PairStringStringVector___len__(self)

    def __getslice__(self, i, j):
        return _swig_decoders.PairStringStringVector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _swig_decoders.PairStringStringVector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _swig_decoders.PairStringStringVector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _swig_decoders.PairStringStringVector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _swig_decoders.PairStringStringVector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _swig_decoders.PairStringStringVector___setitem__(self, *args)

    def pop(self):
        return _swig_decoders.PairStringStringVector_pop(self)

    def append(self, x):
        return _swig_decoders.PairStringStringVector_append(self, x)

    def empty(self):
        return _swig_decoders.PairStringStringVector_empty(self)

    def size(self):
        return _swig_decoders.PairStringStringVector_size(self)

    def swap(self, v):
        return _swig_decoders.PairStringStringVector_swap(self, v)

    def begin(self):
        return _swig_decoders.PairStringStringVector_begin(self)

    def end(self):
        return _swig_decoders.PairStringStringVector_end(self)

    def rbegin(self):
        return _swig_decoders.PairStringStringVector_rbegin(self)

    def rend(self):
        return _swig_decoders.PairStringStringVector_rend(self)

    def clear(self):
        return _swig_decoders.PairStringStringVector_clear(self)

    def get_allocator(self):
        return _swig_decoders.PairStringStringVector_get_allocator(self)

    def pop_back(self):
        return _swig_decoders.PairStringStringVector_pop_back(self)

    def erase(self, *args):
        return _swig_decoders.PairStringStringVector_erase(self, *args)

    def __init__(self, *args):
        this = _swig_decoders.new_PairStringStringVector(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def push_back(self, x):
        return _swig_decoders.PairStringStringVector_push_back(self, x)

    def front(self):
        return _swig_decoders.PairStringStringVector_front(self)

    def back(self):
        return _swig_decoders.PairStringStringVector_back(self)

    def assign(self, n, x):
        return _swig_decoders.PairStringStringVector_assign(self, n, x)

    def resize(self, *args):
        return _swig_decoders.PairStringStringVector_resize(self, *args)

    def insert(self, *args):
        return _swig_decoders.PairStringStringVector_insert(self, *args)

    def reserve(self, n):
        return _swig_decoders.PairStringStringVector_reserve(self, n)

    def capacity(self):
        return _swig_decoders.PairStringStringVector_capacity(self)
    __swig_destroy__ = _swig_decoders.delete_PairStringStringVector
    __del__ = lambda self: None
PairStringStringVector_swigregister = _swig_decoders.PairStringStringVector_swigregister
PairStringStringVector_swigregister(PairStringStringVector)
...
class PairStringString(_object):
    ...
    def __init__(self, *args):
        this = _swig_decoders.new_PairStringString(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_setmethods__["first"] = _swig_decoders.PairStringString_first_set
    __swig_getmethods__["first"] = _swig_decoders.PairStringString_first_get
    if _newclass:
        first = _swig_property(_swig_decoders.PairStringString_first_get, _swig_decoders.PairStringString_first_set)
    __swig_setmethods__["second"] = _swig_decoders.PairStringString_second_set
    __swig_getmethods__["second"] = _swig_decoders.PairStringString_second_get
    if _newclass:
        second = _swig_property(_swig_decoders.PairStringString_second_get, _swig_decoders.PairStringString_second_set)
    def __len__(self):
        return 2
    def __repr__(self):
        return str((self.first, self.second))
    ...
    def __setitem__(self, index, val):
        if not (index % 2):
            ...
            self.second = val
    __swig_destroy__ = _swig_decoders.delete_PairStringString
    __del__ = lambda self: None
PairStringString_swigregister = _swig_decoders.PairStringString_swigregister
PairStringString_swigregister(PairStringString)

class PairStringStringVector2(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, PairStringStringVector2, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, PairStringStringVector2, name)
    __repr__ = _swig_repr

    def iterator(self):
        return _swig_decoders.PairStringStringVector2_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _swig_decoders.PairStringStringVector2___nonzero__(self)

    def __bool__(self):
        return _swig_decoders.PairStringStringVector2___bool__(self)

    def __len__(self):
        return _swig_decoders.PairStringStringVector2___len__(self)

    def __getslice__(self, i, j):
        return _swig_decoders.PairStringStringVector2___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _swig_decoders.PairStringStringVector2___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _swig_decoders.PairStringStringVector2___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _swig_decoders.PairStringStringVector2___delitem__(self, *args)

    def __getitem__(self, *args):
        return _swig_decoders.PairStringStringVector2___getitem__(self, *args)

    def __setitem__(self, *args):
        return _swig_decoders.PairStringStringVector2___setitem__(self, *args)

    def pop(self):
        return _swig_decoders.PairStringStringVector2_pop(self)

    def append(self, x):
        return _swig_decoders.PairStringStringVector2_append(self, x)

    def empty(self):
        return _swig_decoders.PairStringStringVector2_empty(self)

    def size(self):
        return _swig_decoders.PairStringStringVector2_size(self)

    def swap(self, v):
        return _swig_decoders.PairStringStringVector2_swap(self, v)

    def begin(self):
        return _swig_decoders.PairStringStringVector2_begin(self)

    def end(self):
        return _swig_decoders.PairStringStringVector2_end(self)

    def rbegin(self):
        return _swig_decoders.PairStringStringVector2_rbegin(self)

    def rend(self):
        return _swig_decoders.PairStringStringVector2_rend(self)

    def clear(self):
        return _swig_decoders.PairStringStringVector2_clear(self)

    def get_allocator(self):
        return _swig_decoders.PairStringStringVector2_get_allocator(self)

    def pop_back(self):
        return _swig_decoders.PairStringStringVector2_pop_back(self)

    def erase(self, *args):
        return _swig_decoders.PairStringStringVector2_erase(self, *args)

    def __init__(self, *args):
        this = _swig_decoders.new_PairStringStringVector2(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def push_back(self, x):
        return _swig_decoders.PairStringStringVector2_push_back(self, x)

    def front(self):
        return _swig_decoders.PairStringStringVector2_front(self)

    def back(self):
        return _swig_decoders.PairStringStringVector2_back(self)

    def assign(self, n, x):
        return _swig_decoders.PairStringStringVector2_assign(self, n, x)

    def resize(self, *args):
        return _swig_decoders.PairStringStringVector2_resize(self, *args)

    def insert(self, *args):
        return _swig_decoders.PairStringStringVector2_insert(self, *args)

    def reserve(self, n):
        return _swig_decoders.PairStringStringVector2_reserve(self, n)

    def capacity(self):
        return _swig_decoders.PairStringStringVector2_capacity(self)
    __swig_destroy__ = _swig_decoders.delete_PairStringStringVector2
    __del__ = lambda self: None
PairStringStringVector2_swigregister = _swig_decoders.PairStringStringVector2_swigregister
PairStringStringVector2_swigregister(PairStringStringVector2)
